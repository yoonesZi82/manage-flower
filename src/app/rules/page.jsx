    ...
    <HomeLayout isLogin={user ? user : false}>
      ...
      >
        <p className="mb-5 text-textBrown text-justify">
          عاشقان کتاب ضمن احترامی که برای حریم شخصی کاربران قائل است، برای خرید،
          ...
          مورد نیاز است و از آنجا که کلیه فعالیت‌های عاشقان کتاب قانونی و مبتنی
          بر قوانین تجارت الکترونیک صورت می‌گیرد و طی فرایند خرید، فاکتور رسمی و
          ...
          باشند، می‌توانند عضویت دریافت خبرنامه عاشقان کتاب را در پروفایل خود
          لغو کنند.{" "}
        </p>
        <p className="mb-0 text-textBrown text-justify">
          عاشقان کتاب ممکن است نقد و نظرهای ارسالی کاربران را در راستای رعایت
          قوانین وب سایت ویرایش کند. همچنین اگر نظر یا پیام ارسال شده توسط
          کاربر، مشمول مصادیق محتوای مجرمانه باشد، عاشقان کتاب می‌تواند از
          اطلاعات ثبت شده برای پیگیری قانونی استفاده کند.حفظ و نگهداری رمز عبور
          بر عهده کاربران است و برای جلوگیری از هرگونه سوء استفاده احتمالی،
          کاربران نباید آن را برای شخص دیگری فاش کنند. عاشقان کتاب هویت شخصی
          کاربران را محرمانه می‌داند و اطلاعات شخصی آنان را به هیچ شخص یا سازمان
          دیگری منتقل نمی‌کند، مگر اینکه با حکم قانونی مجبور باشد در اختیار
          مراجع ذی‌صلاح قرار دهد.عاشقان کتاب اطلاعات کاربران را محافظت و از
          دسترسی‌های غیر قانونی جلوگیری می‌کند.عاشقان کتاب برای حفاظت و نگهداری
        ...
        <p className="mb-5 text-textBrown text-justify">
          در صورتی که تمایلی به دریافت ایمیل‌ها و خبرنامه های عاشقان کتاب

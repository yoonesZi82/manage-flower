    ...
    <>
      <Layout className="w-screen h-screen">
        <Header className="flex items-center p-0">
          <div className="flex flex-col justify-center items-center gap-2 bg-sidebarTheme w-[66%] desktop:w-[15%] laptop:w-[23%] mobile:w-[66%] tablet:w-[38%] h-full">
            <p className="text-secondary text-base">
              {user ? user.name : "نام"}
            </p>
            <p className="text-secondary text-base">عزیز خوش اومدی</p>
          </div>
